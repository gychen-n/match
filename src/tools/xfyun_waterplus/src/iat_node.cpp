...
static int upload_userwords()
{
	...
	fp = fopen("/home/gyc/match_ws/src/tools/xfyun_waterplus/userwords.txt", "rb");
	if (NULL == fp)										
	{
...
void on_speech_begin()
{
	...
	{
		std::stringstream ss;
		ss << "aplay -q /home/gyc/match_ws/src/tools/xfyun_waterplus/sound/on.wav"; //16khz,单声道
		system(ss.str().c_str());
	}
}
...
int main(int argc, char* argv[])
{
	...
	int ret = MSP_SUCCESS;
	const char* login_params = "appid = d14f6c48, work_dir = .";
